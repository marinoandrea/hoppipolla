...
type PolicyManagerClient interface {
	...
	SubscribePathAnalyzer(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *policyManagerClient) DeletePolicy(ctx context.Context, in *DeletePolicyRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *policyManagerClient) SubscribePathAnalyzer(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type PolicyManagerServer interface {
	...
	// Subcribe an instance of the path analyzer service,
	// stores the client address for identification
	SubscribePathAnalyzer(context.Context, *emptypb.Empty) (*emptypb.Empty, error)
...
func (UnimplementedPolicyManagerServer) DeletePolicy(context.Context, *DeletePolicyRequest) (*emptypb.Empty, error) {
...
func (UnimplementedPolicyManagerServer) SubscribePathAnalyzer(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
...
func _PolicyManager_SubscribePathAnalyzer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PolicyManagerServer).SubscribePathAnalyzer(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
