...
export namespace hoppipolla.policy {
    export class Issuer extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.default != false)
                writer.writeBool(5, this.default);
    ...
    export class Policy extends pb_1.Message {
        ...
        get issuer() {
            return pb_1.Message.getWrapperField(this, Issuer, 4) as Issuer;
        }
        ...
        static fromObject(data: {
            ...
            created_at?: string;
            updated_at?: string;
            issuer?: ReturnType<typeof Issuer.prototype.toObject>;
            active?: boolean;
            statements?: string;
            title?: string;
            description?: string;
            ...
            if (data.issuer != null) {
                message.issuer = Issuer.fromObject(data.issuer);
            }
            if (data.active != null) {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.statements.length)
                writer.writeString(6, this.statements);
            if (this.title.length)
                writer.writeString(7, this.title);
            if (this.has_description)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        reader.readMessage(message.issuer, () => message.issuer = Issuer.deserialize(reader));
                        break;
                    case 5:
    ...
    export class CreatePolicyResponse extends pb_1.Message {
        ...
        get policy() {
            return pb_1.Message.getWrapperField(this, Policy, 1) as Policy;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.has_policy)
                writer.writeMessage(1, this.policy, () => this.policy.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
    ...
    export class UpdatePolicyRequest extends pb_1.Message {
        ...
        static fromObject(data: {
            ...
            const message = new UpdatePolicyRequest({});
            if (data.id != null) {
                message.id = data.id;
            }
            if (data.statements != null) {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): UpdatePolicyRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new UpdatePolicyRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes: Uint8Array): UpdatePolicyRequest {
            return UpdatePolicyRequest.deserialize(bytes);
        }
    }
    export class UpdatePolicyResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            policy?: Policy;
        }) {
        ...
        static fromObject(data: {
            ...
            const message = new UpdatePolicyResponse({});
            if (data.policy != null) {
                message.policy = Policy.fromObject(data.policy);
            }
            return message;
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): UpdatePolicyResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new UpdatePolicyResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes: Uint8Array): UpdatePolicyResponse {
            return UpdatePolicyResponse.deserialize(bytes);
        }
    }
    ...
    export class CreateIssuerResponse extends pb_1.Message {
        ...
        get issuer() {
            return pb_1.Message.getWrapperField(this, Issuer, 1) as Issuer;
        }
        set issuer(value: Issuer) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.has_issuer)
                writer.writeMessage(1, this.issuer, () => this.issuer.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
    ...
    export class GetPolicyRequest extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            id?: string;
        }) {
        ...
        static fromObject(data: {
            ...
            const message = new GetPolicyRequest({});
            if (data.id != null) {
                message.id = data.id;
            }
            return message;
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetPolicyRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new GetPolicyRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes: Uint8Array): GetPolicyRequest {
            return GetPolicyRequest.deserialize(bytes);
        }
    }
    export class GetPolicyResponse extends pb_1.Message {
        ...
        static fromObject(data: {
            ...
            const message = new GetPolicyResponse({});
            if (data.policy != null) {
                message.policy = Policy.fromObject(data.policy);
            }
            return message;
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetPolicyResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new GetPolicyResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes: Uint8Array): GetPolicyResponse {
            return GetPolicyResponse.deserialize(bytes);
        }
    }
    ...
    export abstract class UnimplementedPolicyManagerService {
        static definition = {
            ...
            UpdatePolicy: {
                path: "/hoppipolla.policy.PolicyManager/UpdatePolicy",
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: UpdatePolicyRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => UpdatePolicyRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: UpdatePolicyResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => UpdatePolicyResponse.deserialize(new Uint8Array(bytes))
            },
            DeletePolicy: {
            ...
            GetPolicy: {
                path: "/hoppipolla.policy.PolicyManager/GetPolicy",
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: GetPolicyRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => GetPolicyRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: GetPolicyResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => GetPolicyResponse.deserialize(new Uint8Array(bytes))
            }
        };
        ...
        abstract UpdatePolicy(call: grpc_1.ServerUnaryCall<UpdatePolicyRequest, UpdatePolicyResponse>, callback: grpc_1.sendUnaryData<UpdatePolicyResponse>): void;
        ...
        abstract GetPolicy(call: grpc_1.ServerUnaryCall<GetPolicyRequest, GetPolicyResponse>, callback: grpc_1.sendUnaryData<GetPolicyResponse>): void;
    }
    export class PolicyManagerClient extends grpc_1.makeGenericClientConstructor(UnimplementedPolicyManagerService.definition, "PolicyManager", {}) {
        ...
        UpdatePolicy: GrpcUnaryServiceInterface<UpdatePolicyRequest, UpdatePolicyResponse> = (message: UpdatePolicyRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<UpdatePolicyResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<UpdatePolicyResponse>, callback?: grpc_1.requestCallback<UpdatePolicyResponse>): grpc_1.ClientUnaryCall => {
            return super.UpdatePolicy(message, metadata, options, callback);
        };
        ...
        GetPolicy: GrpcUnaryServiceInterface<GetPolicyRequest, GetPolicyResponse> = (message: GetPolicyRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<GetPolicyResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<GetPolicyResponse>, callback?: grpc_1.requestCallback<GetPolicyResponse>): grpc_1.ClientUnaryCall => {
            return super.GetPolicy(message, metadata, options, callback);
        };
    }
}
